...
public class Account : AggregateRoot
{
        ...
        string? referenceNumber = null)
    {
        ...
        RaiseDomainEvent(new TransactionCreated(
            transaction.Id, Id, type, amount,
            transactionDate.ToDateTime(TimeOnly.MinValue, DateTimeKind.Utc),
            category));
    ...
    public void CancelTransaction(Guid transactionId)
    {
        ...
        RaiseDomainEvent(new TransactionCancelled(
            ...
            transaction.TransactionDate.ToDateTime(TimeOnly.MinValue, DateTimeKind.Utc),
