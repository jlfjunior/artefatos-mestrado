        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    recebido_em = table.Column<DateTimeOffset>(type: "timestamptz", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    impressao_do_conteudo = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_requisicao_idempotente", x => new { x.comerciante_id, x.chave });
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_lancamento_comerciante_id",
                table: "lancamento",
                column: "comerciante_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_requisicao_idempotente_criado_em",
                table: "requisicao_idempotente",
                column: "criado_em");
        }
